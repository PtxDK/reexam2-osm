...
void syscall_mutex_init(mutex_t*);
void syscall_mutex_lock(mutex_t*);
void syscall_mutex_unlock(mutex_t*);
void syscall_cond_wait(cond_t*, mutex_t*);
void syscall_cond_signal(cond_t*);
void syscall_cond_broadcast(cond_t*);
